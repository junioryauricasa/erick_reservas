...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-01-2017 a las 07:09:34
...
--
-- Base de datos: `test_select`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `does`
--
...
--
-- Volcado de datos para la tabla `does`
--

INSERT INTO `does` (`does_id`, `does_name`) VALUES
(1, 'Ahuachapán'),
(2, 'Santa Ana'),
(3, 'Sonsonate'),
(4, 'La Libertad'),
...
--
-- Estructura de tabla para la tabla `toes`
--
...
--
-- Volcado de datos para la tabla `toes`
--

INSERT INTO `toes` (`toes_id`, `toes_name`, `does_toes_id`) VALUES
(1, 'Ahuachapán', 1),
(2, 'Jujutla', 1),
(3, 'Atiquizaya', 1),
...
--
-- Indices de la tabla `does`
--
ALTER TABLE `does`
  ADD PRIMARY KEY (`does_id`);

--
-- Indices de la tabla `toes`
--
ALTER TABLE `toes`
  ADD PRIMARY KEY (`toes_id`,`does_toes_id`),
  ADD KEY `fk_TOES_DOES1_idx` (`does_toes_id`);
...
--
-- Filtros para la tabla `toes`
--
ALTER TABLE `toes`
  ADD CONSTRAINT `fk_TOES_DOES1` FOREIGN KEY (`does_toes_id`) REFERENCES `does` (`does_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
